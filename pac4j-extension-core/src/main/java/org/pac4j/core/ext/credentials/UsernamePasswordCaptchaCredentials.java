...
public class UsernamePasswordCaptchaCredentials extends Credentials {
    ...
    public boolean equals(Object o) {
        ...
        final UsernamePasswordCaptchaCredentials that = (UsernamePasswordCaptchaCredentials) o;
        ...
        return !(captcha != null ? !captcha.equals(that.getCaptcha()) : that.getCaptcha() != null);
    }
    ...
    public String toString() {
        return getClass().getSimpleName() + "{" + Pac4jConstants.USERNAME + "='" + username + "', "
