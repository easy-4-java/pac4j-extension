...
public abstract class TokenProfileDefinition<P extends TokenProfile, T extends Token> extends CommonProfileDefinition {
    ...
    protected void raiseProfileExtractionJsonError(String body, String missingNode) {
        getLogger().error("Unable to extract user profile as no JSON node '{}' was found in body: {}", missingNode, body);
    ...
    protected void raiseProfileExtractionJsonError(String body) {
        getLogger().error("Unable to extract user profile as no JSON node was found in body: {}", body);
    ...
    protected void raiseProfileExtractionError(String body) {
        getLogger().error("Unable to extract user profile from body: {}", body);
