...
public abstract class SignatureAuthenticator<C extends SignatureCredentials, P extends SignatureProfile, T extends Signature>
    ...
    public Optional<Credentials> validate(CallContext callContext, Credentials credentials) {
        ...
        signatureCredentials.setUserProfile(profile.get());
        return Optional.of(signatureCredentials);
