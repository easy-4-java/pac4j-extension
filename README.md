...
|---|---|---:|---|---|
| 1.0.x | `feature/2.0.x` (this branch) | 8 | `1.0.x.*` | Legacy projects, Boot 2.x starter line (`javax.servlet`) |
...
```groovy
implementation 'io.github.easy4j:pac4j-extension:2.0.x.x.20260630-SNAPSHOT'
```
